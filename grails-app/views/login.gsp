        ...
        <form class="form-horizontal">
            ...
            <div class="row form-group">
                <div class="col-md-offset-2 col-md-10">
                    <button class="btn btn-default" type="button" onclick="getLoginInput(false)">Login</button>
                </div>
            </div>

            <div class="row form-group">
                <div class="col-md-offset-2 col-md-10">
                    <p>Not a user? <button class="btn btn-primary" type="button" onclick="goToRegister()">Register</button></p>
                </div>
            </div>
        </form>
    </div>
